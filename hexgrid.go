...
//  Package hexgrid implements an n by m hexagonal grid for use in games.
//  A Grid can be used in games with a hex-tile layout such as the games
//  of Hex, Settlers of Catan, and Sid Meier's Civilization 5.
//
...
//  between two adjacent tiles is incident with each tile. Similaryly,
